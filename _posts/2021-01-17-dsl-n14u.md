...
As we can see, services like ssh and pptp are active.
...
```
Given the checks, it seems that it can accept not only firmware belonging to different versions of the router.
